	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'orbit-1': 'orbit-1 4s ease-in-out infinite',
				'orbit-2': 'orbit-2 5s ease-in-out infinite',
				'orbit-3': 'orbit-3 4.5s ease-in-out infinite',
				'orbit-4': 'orbit-4 5.5s ease-in-out infinite',

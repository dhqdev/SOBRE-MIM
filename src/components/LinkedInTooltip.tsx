          ...
          <div className="profile">
            <div className="user">
              ...
              <div className="details">
                ...
                <div className="username">@david-fernandes</div>
              </div>
            </div>
            <div className="about">3000+ Conexões</div>
          </div>
        </div>
        <div className="text">
          <a className="icon" href="https://www.linkedin.com/in/david-fernandes-77a663229/" target="_blank" rel="noopener noreferrer">
            <div className="layer">
              <span />
              <span />
              <span />

...
const TerminalHero = () => {
  ...
  return (
    <section className="min-h-[90vh] flex items-center justify-center relative overflow-visible pt-20 pb-10">
      {/* Subtle background gradient - estendido para cobrir mais área */}
          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-10">
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="h-12 md:h-16 flex items-center justify-center lg:justify-start">
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-muted-foreground font-mono">
                  {displayedText}
                  <span className="animate-pulse">|</span>
                </p>
              </div>

              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 leading-relaxed px-4 lg:px-0">
                💻 Transformando ideias em código.
              </p>
            </div>

            {/* Social Buttons */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 lg:gap-12 pt-8 lg:pt-12 items-center">
              <LinkedInTooltip />
